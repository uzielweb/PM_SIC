 ...
 * @since  1.6
 */
class Pm_sicViewRequest extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PM_SIC_TITLE_REQUEST'), 'request.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_pm_sic.request', $this->item->id);
		}
