...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post"
	...
	<?php echo JHtml::_('grid.sort', 'JPUBLISHED', 'a.state', $listDirn, $listOrder); ?>
			...
			<?php endif; ?>
				...
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_PM_SIC_REQUESTS_CPF', 'a.cpf', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_PM_SIC_REQUESTS_RG', 'a.rg', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_PM_SIC_REQUESTS_TELEPHONE', 'a.telephone', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_PM_SIC_REQUESTS_EMAIL', 'a.email', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_PM_SIC_REQUESTS_CEP', 'a.cep', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_PM_SIC_REQUESTS_CITY', 'a.city', $listDirn, $listOrder); ?>
				</th>
				<th class=''>
